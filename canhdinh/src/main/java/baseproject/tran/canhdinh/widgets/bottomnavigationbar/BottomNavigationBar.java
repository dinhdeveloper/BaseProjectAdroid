package baseproject.tran.canhdinh.widgets.bottomnavigationbar;
...
import baseproject.tran.canhdinh.widgets.bottomnavigationbar.badge.Badge;
import baseproject.tran.canhdinh.widgets.bottomnavigationbar.badge.QBadgeView;
...
//        int[] colors = new int[]{ Color.GRAY, Color.BLACK, Color.GREEN };
    ...
    public void setTitleItem(int index, String title) {
        ...
        item.setText(title);
        decorateTextView(getChildAt(index).findViewById(baseproject.tran.canhdinh.R.id.tv_bottom), item);
