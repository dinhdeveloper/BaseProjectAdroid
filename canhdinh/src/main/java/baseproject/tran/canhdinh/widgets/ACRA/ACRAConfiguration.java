...
import baseproject.tran.canhdinh.widgets.ACRA.sender.HttpSender;
import baseproject.tran.canhdinh.widgets.ACRA.util.DefaultHttpsSocketFactoryFactory;
import baseproject.tran.canhdinh.widgets.ACRA.util.HttpsSocketFactoryFactory;
import baseproject.tran.canhdinh.widgets.ACRA.util.ReflectionException;
import baseproject.tran.canhdinh.widgets.ACRA.util.ReflectionHelper;

import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_APPLICATION_LOGFILE;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_APPLICATION_LOGFILE_LINES;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_CONNECTION_TIMEOUT;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_DELETE_OLD_UNSENT_REPORTS_ON_APPLICATION_START;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_DELETE_UNAPPROVED_REPORTS_ON_APPLICATION_START;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_DIALOG_ICON;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_DISABLE_SSL_CERT_VALIDATION;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_DROPBOX_COLLECTION_MINUTES;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_FORCE_CLOSE_DIALOG_AFTER_TOAST;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_INCLUDE_DROPBOX_SYSTEM_TAGS;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_LOGCAT_FILTER_BY_PID;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_LOGCAT_LINES;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_MAX_NUMBER_OF_REQUEST_RETRIES;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_NOTIFICATION_ICON;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_RES_VALUE;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_SEND_REPORTS_AT_SHUTDOWN;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_SEND_REPORTS_IN_DEV_MODE;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_SHARED_PREFERENCES_MODE;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_SOCKET_TIMEOUT;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.DEFAULT_STRING_VALUE;
import static baseproject.tran.canhdinh.widgets.ACRA.ACRAConstants.NULL_VALUE;
