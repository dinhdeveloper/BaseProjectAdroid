...
import baseproject.tran.canhdinh.widgets.ACRA.collector.Compatibility;
import baseproject.tran.canhdinh.widgets.ACRA.collector.ConfigurationCollector;
import baseproject.tran.canhdinh.widgets.ACRA.collector.CrashReportData;
import baseproject.tran.canhdinh.widgets.ACRA.collector.CrashReportDataFactory;
import baseproject.tran.canhdinh.widgets.ACRA.jraf.android.util.activitylifecyclecallbackscompat.ActivityLifecycleCallbacksCompat;
import baseproject.tran.canhdinh.widgets.ACRA.jraf.android.util.activitylifecyclecallbackscompat.ApplicationHelper;
import baseproject.tran.canhdinh.widgets.ACRA.sender.EmailIntentSender;
import baseproject.tran.canhdinh.widgets.ACRA.sender.HttpSender;
import baseproject.tran.canhdinh.widgets.ACRA.sender.ReportSender;
import baseproject.tran.canhdinh.widgets.ACRA.util.PackageManagerWrapper;
import baseproject.tran.canhdinh.widgets.ACRA.util.ToastSender;
...
public class ErrorReporter implements UncaughtExceptionHandler {
     ...
     *             been called.
     * @deprecated since 4.3.0 Use {@link baseproject.tran.canhdinh.widgets.ACRA.ACRA#getErrorReporter()}
     *             instead.
     */
    @Deprecated
