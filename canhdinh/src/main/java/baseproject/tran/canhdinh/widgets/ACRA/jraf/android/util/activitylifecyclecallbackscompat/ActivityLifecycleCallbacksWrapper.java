 ...
 */
package baseproject.tran.canhdinh.widgets.ACRA.jraf.android.util.activitylifecyclecallbackscompat;
...
/* package */class ActivityLifecycleCallbacksWrapper implements ActivityLifecycleCallbacks {
    private baseproject.tran.canhdinh.widgets.ACRA.jraf.android.util.activitylifecyclecallbackscompat.ActivityLifecycleCallbacksCompat mCallback;

    public ActivityLifecycleCallbacksWrapper(baseproject.tran.canhdinh.widgets.ACRA.jraf.android.util.activitylifecyclecallbackscompat.ActivityLifecycleCallbacksCompat callback) {
        mCallback = callback;
    }
