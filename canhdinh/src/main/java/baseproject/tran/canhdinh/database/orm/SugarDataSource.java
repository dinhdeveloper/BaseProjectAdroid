...
import static baseproject.tran.canhdinh.database.orm.util.ThreadUtil.*;
import static baseproject.tran.canhdinh.database.orm.util.ThreadUtil.doInBackground;
